    ...
    <section id="booking" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`transition-all duration-500 ease-in-out ${
          formData.packageId ? 'grid grid-cols-1 lg:grid-cols-2 gap-8' : 'flex justify-center'
        }`}>
          {/* Booking Form */}
          <motion.form
            initial={{ opacity: 0, y: 30 }}
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 mb-3">
                            ...
                            <div className="flex items-center text-green-600">
                              ...
                              <span className="text-sm font-medium">${selectedPackage.price} per person</span>
                            </div>
                          </div>
                        ...
                        <div className="ml-6 text-right bg-green-50 p-4 rounded-lg border border-green-200">
                          <div className="text-sm text-gray-600 mb-1">Total for {numPeople} {numPeople === 1 ? 'person' : 'people'}</div>
                      ...
                      {formData.safariDate && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-gray-900">
                            {new Date(formData.safariDate).toLocaleDateString()}
                          </span>
                        </div>
                      )}
                      <div className="flex justify-between">
